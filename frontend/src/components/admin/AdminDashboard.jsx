...
const AdminDashboard = () => {
  ...
  // RESTORED: Full Rich Stat Column
        ...
        <div className="space-y-8 animate-fade-in">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
            {stats && Object.keys(stats).map(key => (
                <StatColumn key={key} title={key} data={stats[key]} />
            ))}
          </div>

          {/* LOGS TABLE */}
          <div>
            <h2 className="text-sm font-bold text-neutral-500 mb-3 uppercase tracking-wider">Recent Live Logs</h2>
